view: recently_added {
    derived_table: {
      sql: with ad_status as (
            ...
            ad_changed as (
            SELECT * FROM ad_status WHERE ad_status.ad_PreValue IS NULL),
            ...
            keywords_changed as (
            SELECT * FROM keyword_status WHERE keyword_status.keyword_PreValue  IS NULL),
            ...
            campaign_changed as (
            SELECT * FROM campaign_status WHERE campaign_status.campaign_PreValue  IS NULL),
            ...
            ad_group_changed as (
            SELECT * FROM ad_group_status WHERE ad_group_status.ad_group_PreValue  IS NULL)
            ...
            SELECT
              ...
              ad_changed.ad_status as first_status
            FROM ad_changed
            UNION ALL
            SELECT
              ...
              keywords_changed.keyword_status as first_status
            ...
            SELECT
              ...
              campaign_changed.campaign_status as first_status
            ...
            SELECT
              ...
              ad_group_changed.ad_group_status as first_status
    ...
    dimension: first_status {
      type: string
      sql: CASE WHEN ${TABLE}.first_status = 'Status_Enabled' OR ${TABLE}.first_status = 'ENABLED' OR  ${TABLE}.first_status = 'Status_Active'  THEN 'Enabled'
              ELSE 'Paused'
              END;;
    }
    ...
    measure: count {
      ...
      html:  {% if (recently_added.type._value == 'Ad') %}
            <a href= "/explore/looker_app_google_adwords/recently_added?fields=ad.creative,recently_added.first_added_date, recently_added.first_status&f[recently_added.first_added_date]={{_filters['recently_added.first_added_date']}}"> {{value}}  </a>
            {% elsif (recently_added.type._value == 'Keyword') %}
            <a href= "/explore/looker_app_google_adwords/recently_added?fields=keyword.criteria,recently_added.first_added_date, recently_added.first_status&f[recently_added.first_added_date]={{_filters['recently_added.first_added_date']}}"> {{value}} </a>
             {% elsif (recently_added.type._value == 'Ad Group') %}
            <a href= "/explore/looker_app_google_adwords/recently_added?fields=ad_group.ad_group_name,recently_added.first_added_sate, recently_added.first_status&f[recently_added.first_added_date]={{_filters['recently_added.first_added_date']}}"> {{value}}  </a>
            {% elsif (recently_added.type._value == 'Campaign') %}
            <a href= "/explore/looker_app_google_adwords/recently_added?fields=campaign.campaign_name,recently_added.first_added_date, recently_added.first_status&f[recently_added.first_added_date]={{_filters['recently_added.first_added_date']}}"> {{value}}  </a>
            {% endif %};;
    }
